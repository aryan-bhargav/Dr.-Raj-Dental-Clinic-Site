    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 flex items-center justify-between">
        ...
        <Link href="/" className="flex items-center gap-2 group">
          <div className="w-8 h-8 rounded-full bg-[#2BBCD4] flex items-center justify-center text-white font-bold text-sm transition-transform group-hover:scale-110">
            D
          </div>
          <span className={`font-semibold text-lg transition-colors ${scrolled ? 'text-gray-900' : 'text-white'}`}>
